export const siteConfig = {
  title: "Bob's kitchen",
  description: "Bob's favorite recipes",
  navItems: [
    { href: "/", label: "Recipes" },
  ...
  pagesContent: {
    "/": {
      content: `Claritas est etiam processus dynamicus, qui
...
molestie consequat,`,
    ...
    "/about": {
      content: `<h2>Lorem ipsum dolor sit amet</h2>, <p>consectetuer adipiscing elit, sed diam
